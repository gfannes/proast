            ...
            //Details
            {
                ...
                else
                {
                    if (show_help_)
                    {
                        ...
                        add_help('h', "Move focus left, +Alt to drag");
                        add_help('j', "Move focus down, +Alt to drag");
                        add_help('k', "Move focus up, +Alt to drag");
                        add_help('l', "Move focus right, +Alt to drag");
                        add_help('g', "Move focus to top, +Alt to drag");
                        add_help('G', "Move focus to bottom, +Alt to drag");
